...
lazy_static::lazy_static! {
    ...
    static ref METEORA_DBC_PROGRAM: Pubkey = Pubkey::from_str("dbcij3LWUppWqq96dh6gJWwBifmcGfLSB5D4DuSMaqN").unwrap();
    static ref METEORA_DBC_POOL_AUTHORITY: Pubkey = Pubkey::from_str("FhVo3mqL8PW5pH5U2CN4XE33DokiyZnUwuGpH2hmHLuM").unwrap();
    static ref METEORA_DBC_CONFIG: Pubkey = Pubkey::from_str("FDXLrJU4wLhh2JyQpcrb2TY1KgJ18QQsdEunakSm8Ekg").unwrap();
    static ref RAYDIUM_PLATFORM_CONFIG: Pubkey = Pubkey::from_str("FfYek5vEz23cMkWsdJwG2oa6EphsvXSHrGpdALN4g6W1").unwrap();
    static ref EVENT_AUTHORITY: Pubkey = Pubkey::from_str("8Ks12pbrD6PXxfty1hVQiE9sc289zgU1zHkvXhrSdriF").unwrap();
...
impl Raydium {
    ...
    async fn get_or_fetch_pool_info(
        ...
        let pump_program = *METEORA_DBC_PROGRAM;
...
fn create_buy_accounts(
    ...
    let    referral_account = Pubkey::from_str("2DPAtwB8L12vrMRExbLuyGnC7n2J5LNoZQSejeQGpwkr").unwrap();
    Ok(vec![
        AccountMeta::new_readonly(*METEORA_DBC_POOL_AUTHORITY, false),
        AccountMeta::new(user, true),
        AccountMeta::new_readonly(*METEORA_DBC_CONFIG, false),
